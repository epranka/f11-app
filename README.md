<h1 align="center" style="border-bottom: none;">F11 App</h1>

<h3 align="center">📽️ Make it fullscreen!</h3>
...
> Select the background color or image and press F11 key to make it fullscreen

The web app is here [https://f11.now.sh](https://f11.now.sh)
...
When you select your option which you like, the background comes to the screen.
To toggle fullscreen mode press the F11 on your keyboard.
...
<p align="center">
  <img alt="associated image green screen f11 logo" src="https://f11.now.sh/social.png" />
</p>
